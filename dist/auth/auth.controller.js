...
const public_route_1 = require("../decorator/public-route");
...
let AuthController = class AuthController {
    ...
    retryVerify(email) {
        return this.authService.retryVerify(email);
    }
    getCodeExpired(_id) {
        return this.authService.getCodeExpired(_id);
    }
};
...
__decorate([
    ...
    (0, public_route_1.ResponseMessage)('API Login'),
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], AuthController.prototype, "retryVerify", null);
__decorate([
    (0, common_1.Post)('code-expired'),
    (0, public_route_1.Public)(),
    (0, public_route_1.ResponseMessage)('Get code expired API'),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], AuthController.prototype, "getCodeExpired", null);
